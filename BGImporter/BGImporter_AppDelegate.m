...
- (void)applicationDidFinishLaunching:(NSNotification *)notification{
    ...
    int numberOfCompanies = [self.managedObjectContext numberOfEntitiesWithName:@"BGCompany"];
    NSLog(@"Number of Companies: %@", [NSString stringWithInt:numberOfCompanies]);
    
    //NSArray* cats = allCategories(self.managedObjectContext);
        
    NSLog(@"Number of Categories: %@", [NSString stringWithInt:[self.managedObjectContext numberOfEntitiesWithName:@"BGCategory"]]);
